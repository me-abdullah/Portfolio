...
export const FloatingNav = ({
  ...
  useMotionValueEvent(scrollYProgress, "change", (current) => {
    // Ensure current is defined and provide a fallback for getPrevious()
  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div
        ...
        style={{
          backdropFilter: "blur(16px) saturate(180%)", // Adds blur and saturation
          backgroundColor: "transparent", // Fully transparent background
          borderRadius: "12px",
          border: "1px solid rgba(255, 255, 255, 0.125)", // Slight border
        }}
      >
        {navItems.map((navItem: any, idx: number) => (
          <Link
            ...
            href={navItem.link}
            className={cn(
              "relative dark:text-neutral-50 items-center flex space-x-1 text-neutral-600 dark:hover:text-black-300 hover:text-neutral-500"
            )}
          >
